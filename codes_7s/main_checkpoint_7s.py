...
if __name__ == "__main__":
    ...
    trainer = Trainer.from_argparse_args(
        ...
        resume_from_checkpoint="/workdir/SonyCSL_EEG/RA/MSCSMLME-copy/CLMR/epoch=5999-step=149999.ckpt"
    )
    print('[[[ START ]]]',datetime.datetime.now())
   
    checkpoint_path = "/workdir/SonyCSL_EEG/RA/MSCSMLME-copy/CLMR/epoch=5999-step=149999.ckpt"
